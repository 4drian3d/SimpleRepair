...
public class SimpleRepairFabric implements DedicatedServerModInitializer {
    ...
    public void onInitializeServer() {
        CommandRegistrationCallback.EVENT.register((dispatcher, registryAccess, environment) -> {
            final var cmd = literal("simplerepair")
                    .requires(source -> source.isPlayer() && source.hasPermission(1))
            ...
            dispatcher.register(literal("repair").redirect(cmd.build()));
